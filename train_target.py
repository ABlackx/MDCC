...
import json
from trainer.engine import MDCC

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='MDCC')
    ...
    parser.add_argument('--lr', type=float, default=1e-2, help="learning rate, diff when vit")
    parser.add_argument('--seed', type=int, default=2024, help="random seed")
    parser.add_argument('--output', type=str, default='res/targets')
    parser.add_argument('--output_src', type=str, default='res/ckps/source')
    parser.add_argument('--da', type=str, default='uda', choices=['uda', 'pda'])

    parser.add_argument('--issave', type=str2bool, default=True)
    ...
    parser.add_argument('--par_consistency', type=float, default=0.3)
    parser.add_argument('--das', action='store_true', default=False, help='whether to enable DAS')

    # contrastive learning params
    parser.add_argument('--su_cl_t', type=float, default=0.1, help='temp for supervised contrastive loss')
    ...
    parser.add_argument('--net', type=str, default='resnet50',
                        help="alexnet, vgg16, resnet50, resnet101, deit-B16")
    ...
    def run():
        ...
        args.output_dir_src = osp.join(args.output_src, args.da, args.dset,
                                       names[args.s][0].upper())  # /uda/数据集/源域首字母   存放源域的预训练模型
        ...
        acc_final = MDCC(args).start_train()
